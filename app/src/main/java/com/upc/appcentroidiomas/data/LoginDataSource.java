        ...
        try {
           ...
           call.enqueue(new Callback<LoginResponse>() {
                ...
                public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                    LoggedInUser fakeUser = new LoggedInUser(response.body().userId, response.body().userName, response.body().displayName, response.body().email, response.body().userType, response.body().profileImageUrl);
                    //return fakeUser;
